...
let buton = [
{ callButton: {displayText: `Instagram`, url: `https://instagram.com/sampeanikupicek/`} },
{ urlButton: { displayText: `Call Owner`, phoneNumber : `+62895337447795`} },
...
m.reply('*Join To Group Official Bot : https://chat.whatsapp.com/E14rIyYMuovIfkskhi5QN9*')
break
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:AriiiXd\n'
    + 'ORG:𝙸 𝙰𝚖 𝙺𝙸𝚉𝙰𝙺𝙸𝚇𝙳;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=62895337447795:+62 895-3374-47795\n' 
    + 'item1.X-ABLabel:Creator WonXd - MDt\n'
    + 'item2.EMAIL;type=INTERNET:rixzzkulbet@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/sampeanikupicek\n'
...
_⫹⫺ Author : CacaCantik feat AriiXd
